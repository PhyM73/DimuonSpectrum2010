// -*- C++ -*-
//
// Package:    DimuonSpectrum2010
// Class:      DimuonSpectrum2010
// 
/**\class DimuonSpectrum2010 DimuonSpectrum2010.cc Demo/DimuonSpectrum2010/src/DimuonSpectrum2010.cc
...
class DimuonSpectrum2010: public edm::EDAnalyzer {
public:
	explicit DimuonSpectrum2010(const edm::ParameterSet&);
	~DimuonSpectrum2010();
...
DimuonSpectrum2010::DimuonSpectrum2010(const edm::ParameterSet& iConfig) {
...
DimuonSpectrum2010::~DimuonSpectrum2010() {
...
void DimuonSpectrum2010::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
} //DimuonSpectrum2010::analyze ends


// ------------ method called once each job just before starting event loop  ------------
void DimuonSpectrum2010::beginJob() {

}

// ------------ method called once each job just after ending the event loop  ------------
void DimuonSpectrum2010::endJob() {
}

//define this as a plug-in
DEFINE_FWK_MODULE(DimuonSpectrum2010);
